...
# ============================================================
#  RoboWalker.gd — Medium-tier mob, cybernetic bipedal unit
#  5-dir sprites (e/n/ne/s/se); w/nw/sw handled via flip_h.
#  Based on ZergMob template.
# ============================================================
...
const ATTACK_INTERVAL   = 2.6
const ATTACK_DAMAGE_MIN = 18.0
const ATTACK_DAMAGE_MAX = 32.0
...
var character_name : String = "Robo Walker"
var hp         : float = MAX_HP
